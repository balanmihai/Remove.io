...
window.onload = () => {
  ...
  callApi('https://js-course-2.firebaseio.com/users.json')
    .then(responseBody => {
  ...
  function renderUsers() {
    ...
    function removeOnClick(listItem) {
      listItem.addEventListener('click', () => {
        ...
        callApi(`https://js-course-2.firebaseio.com/users/${userIdToRemove}.json`, 'DELETE')
          .then(() => {
  ...
  button.addEventListener('click', () => {
    ...
    if (newName !== '') {
      ...
      if (userAlreadyExists) {
        ...
        callApi('https://js-course-2.firebaseio.com/users.json', 'POST', newUser)
          .then(responseBody => {
